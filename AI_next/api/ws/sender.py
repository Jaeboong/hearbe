    ...
    async def send_tts_response(self, session_id: str, text: str):
        ...
        try:
            ...
            logger.info(
                ...
                tts_id, session_id, len(text or ""), len(segments), preview,
            )
            chunk_count = 0
            disconnected = False
            for segment_index, segment in enumerate(segments):
                ...
                logger.info(
                    ...
                    tts_id, session_id, segment_index + 1, len(segments),
            ...
            logger.info(
                ...
                tts_id, session_id, chunk_count, len(segments),
            )
