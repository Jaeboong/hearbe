...
import { Volume2, Zap, Users, Shield, ChevronRight, Settings } from 'lucide-react';
                ...
                <header className="main-header">
                    <div className="header-inner">
                        ...
                        <div className="header-btns">
                            ...
                            <button className="btn-setting-helper" onClick={() => setShowMcpModal(true)}>
                                <Settings size={16} /> 설정 도우미
                            </button>
                        </div>
                    </div>
                </header>
                        ...
                        <div className="mode-list">
                            <button className="mode-item" onClick={() => handleModeClick('audio')}>
                                ...
                                <div className="mode-text">
                                    <span className="mode-label purple-text">A형 · 시각장애인 전용</span>
                            ...
                            <button className="mode-item" onClick={() => handleModeClick('big')}>
                                <div className="mode-icon-box indigo">
                                    <Zap size={24} />
                                </div>
                                <div className="mode-text">
                                    <span className="mode-label indigo-text">B형 · 저시력자 전용</span>
                            ...
                            <button className="mode-item" onClick={() => handleModeClick('common')}>
                                <div className="mode-icon-box emerald">
                                    <Users size={24} />
                                </div>
                                <div className="mode-text">
                                    <span className="mode-label emerald-text">C형 · 일반 사용자용</span>
                            ...
                            <button className="mode-item" onClick={() => handleModeClick('sharing')}>
                                <div className="mode-icon-box pink">
                                    <Shield size={24} />
                                </div>
                                <div className="mode-text">
                                    <span className="mode-label pink-text">S형 · 원격 지원</span>
